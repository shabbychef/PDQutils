...
```{r improvedqq,eval=TRUE,echo=TRUE,cache=FALSE,dpi=200,out.width='600px',out.height='500px'}
...
```{r snakuni,eval=TRUE,echo=TRUE,cache=FALSE,dpi=200,out.width='600px',out.height='500px'}
